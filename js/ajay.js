 ...
 */
var cards = [];
var cardsName = ['fa fa-whatsapp', 'fa fa-facebook', 'fa fa-instagram', 'fa fa-power-off', 'fa fa-bug', 'fa fa-instagram', 'fa fa-server', 'fa fa-diamond', 'fa fa-whatsapp', 'fa fa-twitter', 'fa fa-server', 'fa fa-twitter', 'fa fa-power-off', 'fa fa-diamond', 'fa fa-facebook', 'fa fa-bug'];
var openCards = [];
/*
